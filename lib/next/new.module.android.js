...
function enableForegroundServiceScanning(
  config
): void {
  BeaconsManager.enableForegroundServiceScanning(config);
}

function disableForegroundServiceScanning(): void {
  BeaconsManager.disableForegroundServiceScanning();
}
...
function cleanUpRegions() {
  return BeaconsManager.cleanUpRegions();
}
...
function setBackgroundMonitorHandler(
  ...
  RN.AppRegistry.registerHeadlessTask('ReactNativeBeaconHeadlessTask', () => {
