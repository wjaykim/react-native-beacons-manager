...
public class HeadlessJsTaskWorker extends ListenableWorker implements HeadlessJsTaskEventListener {
  private int taskId;
  ...
  public ListenableFuture<Result> startWork() {
    return CallbackToFutureAdapter.getFuture(completer -> {
      HeadlessJsTaskConfig taskConfig = this.getTaskConfig(Arguments.makeNativeMap(this.getInputData().getKeyValueMap()));
